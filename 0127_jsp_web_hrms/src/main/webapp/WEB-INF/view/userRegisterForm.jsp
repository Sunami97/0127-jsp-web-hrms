	...
	<form action="insert.do" method="post">
		<div>
	 		<div class="container">
				...
				<label>* 名前 <br><input type="text" name="name" required="required"><br><br></label>
				<label>* メール <br><input type="text" name="email"><br><br></label>
				<label>* 連絡先 <br><input type="text" name="phone" required="required"><br><br></label>
				<label>* 生年月日 <br><input type="date" name="birthDate" required="required"><br><br></label>
				<label>* 入社日 <br><input type="date" name="joinDate"><br><br></label>
				<label>* 職位 <br><select name="position">
