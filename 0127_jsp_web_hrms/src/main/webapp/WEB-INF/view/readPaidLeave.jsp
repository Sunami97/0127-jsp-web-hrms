...
<body>
	<div class="container">
		<table>
			...
			<tr>
				<th>申請日</th>
				<td>${paidLeaveData.paidLeave.startDate}~
					${paidLeaveData.paidLeave.endDate}</td>
			</tr>
			<tr>
				<th>使用日数</th>
		...
		<div class="button-area center">
			<a
				href="${pageContext.request.contextPath}/paidleave.do?pageNo=${pageNo}">一覧</a>
			<c:if
			...
			<div class="button-area right">
				...
				<form action="<c:url value='/paidleave/status.do'/>" method="post">
					<input type="hidden" name="leaveId"
						value="${paidLeaveData.paidLeave.leaveId}"> <input
						type="hidden" name="status" value="承認" />
				...
				<form action="<c:url value='/paidleave/status.do'/>" method="post">
					<input type="hidden" name="leaveId"
						value="${paidLeaveData.paidLeave.leaveId}"> <input
						type="hidden" name="status" value="却下" />
